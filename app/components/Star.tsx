...
const Star = ({
  ...
  const chance = isVisible && isRandom ? Math.random() : 1;
  ...
  return (
    ...
    >
      <motion.svg
        ...
        aria-label='Star'
        initial={false}
        animate={{ fill: resolvedColor }}
        variants={{ hover: { fill: '#fff', rotateY: 180 } }}
        transition={{ rotateY: { duration: 0.2, ease: 'easeInOut' } }}
      >
